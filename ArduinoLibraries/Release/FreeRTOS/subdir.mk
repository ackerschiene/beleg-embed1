...
FreeRTOS/%.o: ../FreeRTOS/%.c FreeRTOS/subdir.mk
	...
	avr-gcc -I"/home/michel/git/open-cdt-projects/ArduinoCore" -Wall -Os -fpack-struct -fshort-enums -ffunction-sections -fdata-sections -std=gnu99 -funsigned-char -funsigned-bitfields -mmcu=atmega325p -DF_CPU=16000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"

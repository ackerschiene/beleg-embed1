...
FreeRTOS/%.o: ../FreeRTOS/%.c FreeRTOS/subdir.mk
	...
	avr-gcc -I"/home/michel/Schreibtisch/beleg_embed/ArduinoCore/Release" -I"/home/michel/Schreibtisch/beleg_embed/ArduinoCore" -Wall -g2 -gstabs -Os -ffunction-sections -fdata-sections -std=gnu99 -funsigned-char -funsigned-bitfields -mmcu=atmega325p -DF_CPU=16000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
